...
wmax =0.9;         % pso maximum momentum or inertia
wmin =0.4;         % pso minimum momentum or inertia
...
plot(current_position(2,:),current_position(1,:),'x');
axis([0.000005 0.005 10 20]);
pause(0);
